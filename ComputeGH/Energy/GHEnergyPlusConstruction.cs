...
{
    public class GHEnergyPlusConstruciton : PB_Component

    {
        public GHEnergyPlusConstruciton() : base("EnergyPlus Construction", "Construction",
        ...
        {
            pManager.AddTextParameter("Construction", "Construction", "EnergyPlus Construction",
                GH_ParamAccess.list);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                output = names.Select(name =>
                    new EnergyPlusConstruction
                        {
                            Name = name, Preset = preset,
                            Overrides = new EnergyPlusConstructionOverrides().FromJson(overrides)
                        }
                        .ToJson()).ToList();
            }
